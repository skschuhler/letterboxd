...
print(f"Random Guess Accuracy: {round(accuracy_random, 3)}")
...
print(f"Random Guess Precision: {round(precision_random, 3)}")
print(f"Random Guess Recall: {round(recall_random, 3)}")
print(f"Random Guess F1-Score: {round(f1_random, 3)}")
